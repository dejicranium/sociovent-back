...
const service = require('mlar').mreq('services', 'events/delete');
...
vinfo.routeConfig = [{}];
vinfo.routeConfig[0].path = '/:event_id';
vinfo.routeConfig[0].method = 'delete';
vinfo.routeConfig[0].middlewares = [auth, routemeta('delete_event', 'none', ['requestId'])];
