...
const service = require('mlar').mreq('services', 'events/addbookmark');
...
vinfo.routeConfig = [{}];
vinfo.routeConfig[0].path = '/bookmarks';
vinfo.routeConfig[0].method = 'post';
vinfo.routeConfig[0].middlewares = [auth, routemeta('add_bookmarks', 'none', ['requestId'])];
