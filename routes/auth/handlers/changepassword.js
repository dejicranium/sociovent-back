...
const service = require('mlar').mreq('services', 'auth/change_password');
...
vinfo.routeConfig = [{}];
vinfo.routeConfig[0].path = '/password/change';
vinfo.routeConfig[0].method = 'put';
vinfo.routeConfig[0].middlewares = [auth, routemeta('edit_self', 'none', ['requestId'])];
