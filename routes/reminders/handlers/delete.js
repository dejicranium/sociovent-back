...
const service = require('mlar').mreq('services', 'events/deletereminder');
...
vinfo.routeConfig = [{}];
vinfo.routeConfig[0].path = '/:reminder_id';
vinfo.routeConfig[0].method = 'delete';
vinfo.routeConfig[0].middlewares = [auth, routemeta('delete_reminder', 'none', ['requestId'])];
