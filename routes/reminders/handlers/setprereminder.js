...
const service = require('mlar').mreq('services', 'events/setprereminder');
...
vinfo.routeConfig = [{}];
vinfo.routeConfig[0].path = '/preminder';
vinfo.routeConfig[0].method = 'post';
vinfo.routeConfig[0].middlewares = [routemeta('delete_reminder', 'none', ['requestId'])];
